...
# Version: 1.3.1 - Enhanced with OS-specific startup scripts
...
# RadiusForge Universal Installation Script v1.3.1
...
cat > ${BUILD_DIR}/${FULL_BUNDLE}/manifest.json << EOF
{
  ...
  "changes_from_v1.3.0": [
    "Added OS-specific startup scripts",
...
echo ""
echo "🚀 Key Features:"
echo "   • OS-specific startup scripts (macOS & RHEL)"
echo "   • Universal installer with OS detection"
echo "   • Service management (systemd/launchd)"
echo "   • Health monitoring on port 8917"
echo "   • Full cross-platform support"
echo ""