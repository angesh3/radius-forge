...
class RADIUSPacket:
    ...
    @classmethod
    def from_bytes(cls, data: bytes, secret: str = None) -> 'RADIUSPacket':
...
class RADIUSGenerator:
    ...
    def create_accounting_request(self, username: str, session_id: str, 
                                status_type: int, nas_port: int = 1) -> RADIUSPacket:
    ...
    async def send_packet(self, packet: RADIUSPacket, sock: socket.socket = None) -> Optional[RADIUSPacket]:
    ...
    async def run_load_test(self, 
                          ...
                          ramp_up_seconds: int = 30) -> RADIUSMetrics:
        ...
        logger.info(f"Load test completed. Sent: {self.metrics.packets_sent}, "
