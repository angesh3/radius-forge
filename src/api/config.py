...
class Settings(BaseSettings):
    ...
    DATABASE_URL: str = Field(
        default="postgresql+asyncpg://radiusforge:radiusforge@radiusforge-db:5432/radiusforge", env="DATABASE_URL"
    )
    DATABASE_ECHO: bool = Field(default=False, env="DATABASE_ECHO")

    # Redis Configuration (for caching and session storage)
    REDIS_URL: str = Field(default="redis://radiusforge-redis:6379/0", env="REDIS_URL")
