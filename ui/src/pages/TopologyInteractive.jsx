...
const TopologyInteractive = () => {
  ...
  const [topology, setTopology] = useState({
    ...
    connections: [
      ...
      { id: 'c3', from: 'nad-cluster-a', to: 'asset-manager', protocol: 'RADIUS', active: true, enabled: true },
      { id: 'c4', from: 'nad-cluster-b', to: 'asset-manager', protocol: 'RADIUS', active: true, enabled: true },
      { id: 'c5', from: 'asset-manager', to: 'cisco-ise', protocol: 'pxGrid', active: false, enabled: false },
      { id: 'c6', from: 'nad-cluster-a', to: 'syslog-siem', protocol: 'Syslog', active: true, enabled: true },
      { id: 'c7', from: 'nad-cluster-b', to: 'syslog-siem', protocol: 'Syslog', active: true, enabled: true },
    ]
  });
                ...
                <FormControlLabel
                  control={
                    <Switch 
                      ...
                      disabled={selectedNode.required}
                    />
                  }
...
export default TopologyInteractive;
