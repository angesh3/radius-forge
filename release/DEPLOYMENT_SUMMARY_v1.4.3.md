# RadiusForge v1.4.3 - Universal Deployment Bundle
...
```bash
# Transfer bundle
scp RADIUSFORGE-PRODUCTION-V1.4.3-COMPLETE.tar.gz user@mac-server:/tmp/

# On macOS server
tar -xzf /tmp/RADIUSFORGE-PRODUCTION-V1.4.3-COMPLETE.tar.gz
cd RADIUSFORGE-PRODUCTION-V1.4.3-COMPLETE
...
```bash
# Transfer bundle
scp RADIUSFORGE-PRODUCTION-V1.4.3-COMPLETE.tar.gz user@rhel-server:/tmp/
...
---
Version: 1.4.3
Build: 20250930_185147
Bundle: RADIUSFORGE-PRODUCTION-V1.4.3-COMPLETE.tar.gz
Size: 14M
SHA256: f8d43f7d60a03e2757aee06e1afe99f1e38c26023906fc1ac81c4463d8e5613d
Validation: release/validation-1.4.3.log
