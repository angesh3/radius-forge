# RadiusForge v1.4.2 - Universal Deployment Bundle
...
```bash
# Transfer bundle
scp RADIUSFORGE-PRODUCTION-V1.4.2-COMPLETE.tar.gz user@mac-server:/tmp/

# On macOS server
tar -xzf /tmp/RADIUSFORGE-PRODUCTION-V1.4.2-COMPLETE.tar.gz
cd RADIUSFORGE-PRODUCTION-V1.4.2-COMPLETE
...
```bash
# Transfer bundle
scp RADIUSFORGE-PRODUCTION-V1.4.2-COMPLETE.tar.gz user@rhel-server:/tmp/
...
---
Version: 1.4.2
Build: 20250930_185005
Bundle: RADIUSFORGE-PRODUCTION-V1.4.2-COMPLETE.tar.gz
Size: 14M
SHA256: 2ccc3ae74f6819061b7fc2df5727c57e38313ed92075132e11bacfcc65392956
Validation: release/validation-1.4.2.log
