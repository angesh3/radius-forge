# RadiusForge v1.4.0 - Universal Deployment Bundle
...
```bash
# Transfer bundle
scp RADIUSFORGE-PRODUCTION-V1.4.0-COMPLETE.tar.gz user@mac-server:/tmp/

# On macOS server
tar -xzf /tmp/RADIUSFORGE-PRODUCTION-V1.4.0-COMPLETE.tar.gz
...
```bash
# Transfer bundle
scp RADIUSFORGE-PRODUCTION-V1.4.0-COMPLETE.tar.gz user@rhel-server:/tmp/
